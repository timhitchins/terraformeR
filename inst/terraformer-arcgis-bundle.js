...
})()(
  {
    1: [
      function (require, module, exports) {
        (function (global) {
          (function () {
            global.Terraformer = require("@terraformer/arcgis");
          }.call(this));
        }.call(
          this,
      ...
      function (require, module, exports) {
        ...
        (function (global, factory) {
          typeof exports === "object" && typeof module !== "undefined"
            ...
            : ((global = global || self),
              factory((global.Terraformer = global.Terraformer || {})));
          ...
          var coordinatesContainPoint = function coordinatesContainPoint(
            coordinates,
            point
          ) {
            var contains = false;
          ...
          var coordinatesContainCoordinates =
          ...
          var flattenMultiPolygonRings = function flattenMultiPolygonRings(
            rings
          ) {
            var output = [];
          ...
          var geojsonToArcGIS = function geojsonToArcGIS(geojson, idAttribute) {
            ...
            switch (geojson.type) {
              ...
              case "MultiPolygon":
                result.rings = flattenMultiPolygonRings(
                  geojson.coordinates.slice(0)
                );
              ...
              case "Feature":
                if (geojson.geometry) {
                  result.geometry = geojsonToArcGIS(
                    geojson.geometry,
                    idAttribute
                  );
                }
              ...
              case "FeatureCollection":
                ...
                for (i = 0; i < geojson.features.length; i++) {
                  result.push(
                    geojsonToArcGIS(geojson.features[i], idAttribute)
                  );
                }
              ...
              case "GeometryCollection":
                ...
                for (i = 0; i < geojson.geometries.length; i++) {
                  result.push(
                    geojsonToArcGIS(geojson.geometries[i], idAttribute)
                  );
                }
