(function () {
...
})()(
  {
    1: [
      function (require, module, exports) {
        (function (global) {
          (function () {
            global.Terraformer.WKT = require("terraformer-wkt-parser");
          }.call(this));
        }.call(
          this,
      ...
      function (require, module, exports) {
        (function (root, factory) {
          ...
          if (
            ...
            if (!root.Terraformer) {
              throw new Error(
                "Terraformer.WKT requires the core Terraformer library. http://github.com/esri/terraformer"
              );
            }
          ...
          var parser = (function () {
            var parser = {
              ...
              table: [
                ...
                { 17: [1, 55] },
                { 5: [2, 19] },
                { 11: 58, 12: [1, 52], 17: [1, 59], 24: 57, 27: 56 },
                { 17: [1, 60] },
                { 17: [1, 61] },
                { 17: [1, 62] },
                { 5: [2, 31] },
                ...
                { 17: [1, 68] },
                { 5: [2, 36] },
                { 11: 58, 12: [1, 52], 17: [1, 59], 24: 57, 27: 69 },
                { 17: [1, 70] },
                { 17: [1, 71] },
                { 17: [1, 72] },
                { 5: [2, 41] },
                ...
                { 11: 58, 12: [1, 52], 17: [1, 59], 24: 57, 27: 93 },
                { 11: 58, 12: [1, 52], 17: [1, 59], 24: 57, 27: 94 },
                { 14: [1, 96], 18: [1, 95] },
                { 14: [2, 13], 18: [2, 13] },
                { 11: 51, 12: [1, 52], 13: 97 },
                { 15: 98, 16: 64, 17: [1, 65] },
                { 15: 99, 16: 64, 17: [1, 65] },
                { 15: 100, 16: 64, 17: [1, 65] },
                { 14: [1, 90], 18: [1, 101] },
                { 11: 58, 12: [1, 52], 17: [1, 59], 24: 57, 27: 102 },
                { 11: 58, 12: [1, 52], 17: [1, 59], 24: 57, 27: 103 },
                { 11: 58, 12: [1, 52], 17: [1, 59], 24: 57, 27: 104 },
                { 14: [1, 96], 18: [1, 105] },
                { 15: 106, 16: 64, 17: [1, 65] },
                { 15: 107, 16: 64, 17: [1, 65] },
                { 15: 108, 16: 64, 17: [1, 65] },
                { 14: [1, 110], 18: [1, 109] },
                { 14: [2, 23], 18: [2, 23] },
                { 15: 111, 16: 64, 17: [1, 65] },
                { 17: [1, 79], 25: 112, 26: 78 },
                { 17: [1, 79], 25: 113, 26: 78 },
                { 17: [1, 79], 25: 114, 26: 78 },
                { 5: [2, 15] },
                { 11: 115, 12: [1, 52] },
                { 12: [1, 116], 14: [2, 7], 18: [2, 7] },
                { 14: [1, 84], 18: [1, 117] },
                { 14: [1, 84], 18: [1, 118] },
                { 14: [1, 84], 18: [1, 119] },
                { 5: [2, 27] },
                { 11: 58, 12: [1, 52], 17: [1, 59], 24: 120 },
                { 18: [1, 121] },
                { 14: [1, 90], 18: [1, 122] },
                { 14: [1, 90], 18: [1, 123] },
                { 14: [1, 90], 18: [1, 124] },
          ...
          function pointToWKTPoint(primitive) {
            ...
            if (
              primitive.coordinates === undefined ||
              primitive.coordinates.length === 0
            ) {
              ret += "EMPTY";
          ...
          function lineStringToWKTLineString(primitive) {
            ...
            if (
              primitive.coordinates === undefined ||
              primitive.coordinates.length === 0 ||
              primitive.coordinates[0].length === 0
            ) {
              ret += "EMPTY";
          ...
          function multiPolygonToWKTMultiPolygon(primitive) {
            ...
            if (
              ...
              primitive.coordinates.length === 0 ||
              primitive.coordinates[0].length === 0 ||
              primitive.coordinates[0][0].length === 0
            ) {
              ret += "EMPTY";
          ...
          function calculateBounds(geojson) {
            if (geojson.type) {
              switch (geojson.type) {
                ...
                case "MultiPolygon":
                  return calculateBoundsFromNestedArrayOfArrays(
                    geojson.coordinates
                  );

                case "Feature":
                  return geojson.geometry
                    ? calculateBounds(geojson.geometry)
                    : null;
  ...
  */
          function calculateBoundsForGeometryCollection(geometryCollection) {
            ...
            for (
              var i = geometryCollection.geometries.length - 1;
              i >= 0;
              i--
            ) {
  ...
  */
          function positionToGeographic(position) {
            ...
            return [
              ...
              radToDeg(
                Math.PI / 2 - 2 * Math.atan(Math.exp((-1.0 * y) / EarthRadius))
              ),
            ];
          }
  ...
  */
          function applyConverter(geojson, converter, noCrs) {
            if (geojson.type === "Point") {
              ...
              geojson.geometry = applyConverter(
                geojson.geometry,
                converter,
                true
              );
              ...
              geojson.coordinates = eachPosition(
                geojson.coordinates,
                converter
              );
            }
  ...
  */
          ...
          function nextHullPoint(points, p) {
            ...
            for (var r in points) {
              ...
              if (
                t === -1 ||
                (t === 0 &&
                  euclideanDistance(p, points[r]) > euclideanDistance(p, q))
              ) {
                q = points[r];
              }
            }
          ...
          function isConvex(points) {
            ...
            for (var i = 0; i < points.length - 3; i++) {
              ...
              var res =
                p3[0] * v[1] - p3[1] * v[0] + v[0] * p1[1] - v[1] * p1[0];
  ...
  */
          ...
          Primitive.prototype.within = function (primitive) {
            ...
            if (
              primitive.type === "LineString" ||
              primitive.type === "MultiPoint"
            ) {
              if (this.type === "Point") {
                for (i = 0; i < primitive.coordinates.length; i++) {
                  if (
                    this.coordinates.length !== primitive.coordinates[i].length
                  ) {
                    return false;
                  }
            ...
            if (primitive.type === "Polygon") {
              ...
              if (this.type === "Polygon") {
                ...
                if (
                  ...
                  return !arraysIntersectArrays(
                    closedPolygon(this.coordinates),
                    closedPolygon(primitive.coordinates)
                  );
                } else {
                  return false;
                }
              ...
              if (this.type === "Point") {
                if (primitive.coordinates.length) {
                  for (i = 0; i < primitive.coordinates.length; i++) {
                    coordinates = primitive.coordinates[i];
                    if (
                      polygonContainsPoint(coordinates, this.coordinates) &&
                ...
                for (i = 0; i < this.coordinates.length; i++) {
                  if (
                    primitive.coordinates[i].length === this.coordinates.length
                  ) {
                    for (j = 0; j < this.coordinates.length; j++) {
                      if (
                        coordinatesEqual(
                          this.coordinates[j],
                          primitive.coordinates[i][j]
                        )
                      ) {
                        return true;
                      }
          ...
          Primitive.prototype.intersects = function (primitive) {
            ...
            warn(
              "Type " +
                ...
                " to " +
                primitive.type +
                " intersection is not supported by intersects"
            );
            return false;
          };
  ...
  */
          ...
          function Circle(center, radius, interpolate) {
            ...
            if (!center || center.length < 2 || !rad || !steps) {
              throw new Error(
                "Terraformer: missing parameter for Terraformer.Circle"
              );
            }
